						...
						<React.Fragment>
							<div className="relative border-b-4 border-blue-400">
								<div className="absolute w-5/6 bottom-0 bg-white p-8">
									...
									<Link to={{pathname: `${portfolio.acf.work_url}` }} className="text-xl font-bold text-gray-500 flex items-center hover:text-blue-400">{portfolio.acf.work_link_text}<span className="ml-2 text-2xl"><BsIcons.BsArrowRight /></span></Link>
								</div>
